...
my @second = (
    "het overgrote deel van de input/output coördinatie ", "een voortdurende stroom van effectieve informatie ",
    "de karakterisering van specifieke criteria ",         "de initialisering van de ontwikkeling van het kritieke subsysteem ",
    "het volledig geïntegreerde testprogramma ",           "de basis van de productconfiguratie ",
    "ieder geassocieerd dienstverlenend element ",         "de incorporatie van additionele uitvoeringsvoorwaarden ",
    "het onafhankelijk functioneel principe ",             "de primaire interrelatie van technologieën "
);
my @third = (
    ...
    "verder geëlaboreerd wordt met beschouwingen ten aanzien van ",
...
my @fourth = (
    ...
    "de initiële grenzen van de classificatie-limiet",
