...
# <td width="48" bgcolor="#666666" valign="bottom"> 21:05</td>
# <td bgcolor="#666666" valign="bottom" width="48"> 21:47</td>

        @items = split m|<td bgcolor="#666666" valign="bottom" width="48">.*?(\d{2}:\d{2}).*?</td>|, $content; 
